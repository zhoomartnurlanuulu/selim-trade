...
// Other services
  ...
  //Repositories
  sl.registerFactory<AdvantageRepo>(() => AdvantageRepoImpl(dio: sl()));
  ...
  // Use cases
  sl.registerFactory<AdvantageUseCase>(() => AdvantageUseCase(repo: sl()));
  sl.registerFactory<QuestionsUseCase>(() => QuestionsUseCase(repo: sl()));
  ...
  // blocs
  sl.registerFactory<AdvantageCubit>(() => AdvantageCubit(useCase: sl()));
  sl.registerFactory<QuestionsCubit>(() => QuestionsCubit(useCase: sl()));
  sl.registerFactory<GatesCubit>(() => GatesCubit(useCase: sl()));
  sl.registerFactory<BenifitsCubit>(() => BenifitsCubit(useCase: sl()));
  sl.registerFactory<ServicesCubit>(() => ServicesCubit(useCase: sl()));
  sl.registerFactory<OurWorksCubit>(() => OurWorksCubit(useCase: sl()));
  sl.registerFactory<NewsCubit>(() => NewsCubit(useCase: sl()));
  sl.registerFactory<ReviewsCubit>(() => ReviewsCubit(useCase: sl()));
  sl.registerFactory<SocialMediaCubit>(() => SocialMediaCubit(useCase: sl()));
  sl.registerFactory<AddressCubit>(() => AddressCubit(useCase: sl()));
  sl.registerFactory<WorkTimeCubit>(() => WorkTimeCubit(useCase: sl()));
  sl.registerFactory<PhonesCubit>(() => PhonesCubit(useCase: sl()));
}
